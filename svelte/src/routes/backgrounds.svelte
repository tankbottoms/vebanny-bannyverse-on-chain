<script lang="ts">
	...
	onMount(async () => {
        ...
        let tokens: HTMLCollectionOf<Element> | Element[] = document.getElementsByClassName('bannyPlaceholder')
...
<section>
	{#each lockPeriods as lockPeriod, i}
		<Background topText={lockPeriod} bottomText={`${jbxRange} JBX`} options={getOptionsForLockPeriod(i)}>
