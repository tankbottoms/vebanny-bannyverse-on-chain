...
export default class BalanceTree {
    ...
    public static toNode(index: number | BigNumber, account: string, data: number | BigNumber): Buffer {
        return Buffer.from(utils.solidityKeccak256(['uint256', 'address', 'uint256'], [index, account, data]).slice(2), 'hex');
    }
